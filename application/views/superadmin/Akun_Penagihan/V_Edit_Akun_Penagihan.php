        ...
        <div class="card mb-6 shadow-lg border-0 rounded-3">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between pb-4 border-bottom">
                    <div class="button-wrapper">
                        <h3 class="mb-0 text-primary fw-bold">Edit Akun Penagihan</h3>
            ...
            <div class="card-body pt-4">
                ...
                <?php foreach ($Data_Akun as $data) : ?>
                    <form method="POST" action="<?php echo base_url('superadmin/Akun_Penagihan/C_Edit_Akun_Penagihan/Edit_Save') ?>">
                        <div class="row g-4">

                            <input type="hidden" class="form-control" name="id_penagih" value="<?php echo $data['id_penagih'] ?>" readonly>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="email_login_akun" name="email_login_akun" class="form-control fw-bold" required>
                                        <?php foreach ($Data_Login as $dataLogin) : ?>
                                            <option value="<?php echo $dataLogin['email_login'] ?>" <?= $data['email_login'] == $dataLogin['email_login'] ? "selected" : null ?>>
                                                <?php echo $dataLogin['email_login'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="nama_penagihan" value="<?php echo $data['nama_penagih'] ?>" placeholder="Masukkan nama..." required>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="area_1" name="area_1" class="form-control fw-bold" required>
                                        <?php foreach ($Data_Area as $dataArea) : ?>
                                            <option value="<?php echo $dataArea['nama_area'] ?>" <?= $data['area_1'] == $dataArea['nama_area'] ? "selected" : null ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="area_2" name="area_2" class="form-control fw-bold">
                                        <option value="" <?= empty($data['area_2']) ? 'selected' : '' ?>>Pilih Area</option>

                                        <?php foreach ($Data_Area as $dataArea) : ?>
                                            <option value="<?= $dataArea['nama_area'] ?>" <?= $data['area_2'] == $dataArea['nama_area'] ? 'selected' : '' ?>>
                                                <?= $dataArea['nama_area'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="area_3" name="area_3" class="form-control fw-bold">
                                        <option value="" <?= empty($data['area_3']) ? 'selected' : '' ?>>Pilih Area</option>

                                        <?php foreach ($Data_Area as $dataArea) : ?>
                                            <option value="<?= $dataArea['nama_area'] ?>" <?= $data['area_3'] == $dataArea['nama_area'] ? 'selected' : '' ?>>
                                                <?= $dataArea['nama_area'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="area_4" name="area_4" class="form-control fw-bold">
                                        <option value="" <?= empty($data['area_4']) ? 'selected' : '' ?>>Pilih Area</option>

                                        <?php foreach ($Data_Area as $dataArea) : ?>
                                            <option value="<?= $dataArea['nama_area'] ?>" <?= $data['area_4'] == $dataArea['nama_area'] ? 'selected' : '' ?>>
                                                <?= $dataArea['nama_area'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="area_5" name="area_5" class="form-control fw-bold">
                                        <option value="" <?= empty($data['area_5']) ? 'selected' : '' ?>>Pilih Area</option>

                                        <?php foreach ($Data_Area as $dataArea) : ?>
                                            <option value="<?= $dataArea['nama_area'] ?>" <?= $data['area_5'] == $dataArea['nama_area'] ? 'selected' : '' ?>>
                                                <?= $dataArea['nama_area'] ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
