                                     ...
                                     <div class="p-3 bg-white shadow-sm rounded mb-3 border">
                                         <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                                             ...
                                             <div class="mb-3 mb-md-0">
                                                 <h4 class="mb-1">Data Akun Penagihan</h4>
                                             </div>

                                             <!-- Aksi untuk Desktop -->
                                             <div class="d-none d-md-flex flex-wrap align-items-center gap-2">

                                                 <a href="<?= base_url('superadmin/Akun_Penagihan/C_Tambah_Akun_Penagihan') ?>" class="btn btn-primary">
                                             ...
                                             <div class="d-flex d-md-none flex-column gap-2 mt-3 w-100">
                                                 ...
                                                 <a href="<?= base_url('superadmin/Akun_Penagihan/C_Tambah_Akun_Penagihan') ?>" class="btn btn-primary w-100">
                                                     <i class="bi bi-plus-lg me-1"></i> Tambah
                                                 </a>
                                             </div>
                             ...
                             <table id="mytable" class="table  table-striped table-bordered responsive nowrap" style="width:100%">
                                 <thead class="table-light">
                                     <tr>
                                         ...
                                         <th class="text-center">Area 1</th>
                                         <th class="text-center">Area 2</th>
                                         <th class="text-center">Area 3</th>
                                         <th class="text-center">Area 4</th>
                                         <th class="text-center">Area 5</th>
