                      ...
                      <div class="col-md-12">
                          ...
                          <div class="nav-align-top">
                              <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-md-0 gap-2">
                                  <li class="nav-item">
                                      <a class="nav-link" href="<?php echo base_url('user/Belum_Lunas/C_Pembayaran_Perbulan') ?>"><i class="icon-base bx bx-user icon-sm me-1_5"></i> Pembayaran Wifi Bulanan</a>
                                  </li>
                                  <li class="nav-item">
                          ...
                          <div class="card-body pt-4">
                              ...
                              <?php foreach ($Data_Pelanggan as $data) : ?>
                                  <form method="POST" action="<?php echo base_url('user/Belum_Lunas/C_Pembayaran_Perhari/PaymentSave') ?>">
                                      <div class="row g-4">
