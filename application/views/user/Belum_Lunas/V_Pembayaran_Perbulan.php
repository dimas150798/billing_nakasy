                      ...
                      <div class="col-md-12">
                          ...
                          <div class="nav-align-top">
                              <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-md-0 gap-2">
                                  <li class="nav-item">
                                      <a class="nav-link active" href="javascript:void(0);"><i class="icon-base bx bx-user icon-sm me-1_5"></i> Pembayaran Wifi Bulanan</a>
                                  </li>
                                  <li class="nav-item">
                                      <a class="nav-link" href="<?php echo base_url('user/Belum_Lunas/C_Pembayaran_Perhari') ?>"><i class="icon-base bx bx-user icon-sm me-1_5"></i> Pembayaran Wifi Harian</a>
                                  </li>
                              </ul>
                          </div>
                              ...
                              <div class="card-body">
                                  <div class="d-flex align-items-start align-items-sm-center gap-6 pb-4 border-bottom">
                                      <h3 class="mb-0 text-primary fw-bold">
                                          <i class="bi bi-wifi me-2"></i> Pembayaran Wifi Bulanan
                                      </h3>
                                  </div>
                              </div>
                          </div>
                          ...
                          <div class="card-body pt-4">
                              ...
                              <?php foreach ($Data_Pelanggan as $data) : ?>
                                  <form method="POST" action="<?php echo base_url('user/Belum_Lunas/C_Pembayaran_Perbulan/PaymentSave') ?>">
                                      <div class="row g-4">
                                          ...
                                          <!-- Harga Paket -->
                                          <div class="col-md-6">
                                              <label class="form-label fw-bold fs-6">Harga Paket Internet: </label>
                                              <div class="input-group">
                                                  <span class="input-group-text bg-primary text-white"><i class="bi bi-currency-dollar"></i></span>
                                                  <input type="text" class="form-control" name="" value="<?= number_format($data['harga_paket'], 0, ',', '.') ?>" readonly>
                                              </div>
                                          </div>
