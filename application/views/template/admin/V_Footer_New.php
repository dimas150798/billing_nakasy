<!-- Footer -->
<footer class="bg-white text-center py-2 border-top mt-auto">
    <div class="container">
        <small class="text-muted">© <?= date('Y') ?> Panel Billing. All rights reserved.</small>
</footer>

</div> <!-- penutup d-flex flex-column -->
