        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <div class="app-brand demo">
                    <a href="<?= base_url('user/C_Dashboard_User') ?>" class="app-brand-link d-flex align-items-center">
                        <img
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="<?php echo base_url('user/Sudah_Lunas/C_Sudah_Lunas') ?>" class="menu-link">
                                    <i class="menu-icon tf-icons bx bx-check-circle"></i>
                                    <div class="text-truncate" data-i18n="Without menu">Sudah Lunas</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="<?php echo base_url('user/Belum_Lunas/C_Belum_Lunas') ?>" class="menu-link">
