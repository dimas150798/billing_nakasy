            ...
            <div class="container-fluid d-flex align-items-center">
                ...
                <ul class="nav nav-pills d-none d-lg-flex ms-2">
                    <li class="nav-item mx-1">
                        <a class="nav-link text-white fw-semibold <?= $this->uri->segment(3) == 'C_Sudah_Lunas' ? 'active' : '' ?>" href="<?= base_url('user/Sudah_Lunas/C_Sudah_Lunas') ?>">
                            <i class="bx bx-check-circle me-1"></i> Sudah Lunas
                        </a>
                    </li>
                    <li class="nav-item mx-1">
                        <a class="nav-link text-white fw-semibold <?= $this->uri->segment(3) == 'C_Belum_Lunas' ? 'active' : '' ?>" href="<?= base_url('user/Belum_Lunas/C_Belum_Lunas') ?>">
