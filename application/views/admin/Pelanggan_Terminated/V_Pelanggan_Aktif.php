        ...
        <div class="card mb-6 shadow-lg border-0 rounded-3">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between pb-4 border-bottom">
                    <div class="button-wrapper">
                        <h3 class="mb-0 text-primary fw-bold">Mengaktifkan Pelanggan Terminasi</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body pt-4">
                ...
                <?php foreach ($Data_Pelanggan as $data) : ?>
                    <form method="POST" action="<?php echo base_url('admin/Pelanggan_Terminated/C_Pelanggan_Aktif/Pelanggan_AktifSave') ?>">
                        <div class="row g-4">
                            ...
                            <!-- Tanggal Registrasi -->
                            <div class="col-md-6">
                                <label for="start_date" class="form-label fw-bold fs-6">Tanggal Aktif: <span class="text-danger">*</span></label>
                                <div class="input-group">
