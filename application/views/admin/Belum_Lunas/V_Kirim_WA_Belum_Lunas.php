        ...
        <div class="card mb-6 shadow-lg border-0 rounded-3">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between pb-4 border-bottom">
                    <div class="button-wrapper">
                        <h3 class="mb-0 text-primary fw-bold">Tagihan Belum Lunas by WA</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body pt-4">
                ...
                <?php foreach ($Data_Pelanggan as $data) : ?>
                    <form method="POST" action="<?php echo base_url('admin/Belum_Lunas/C_Kirim_WA_Belum_Lunas/KirimWA_Aksi') ?>">
                        <div class="row g-4">
                            ...
                            <!-- Bulan Pembayaran -->
                            <div class="col-md-6">
                                <label class="form-label fw-bold fs-6">Bulan Pembayaran: <span class="text-danger">*</span></label>
                                <div class="input-group">
                                    <span class="input-group-text bg-primary text-white"><i class="bi bi-calendar-event"></i></span>
                                    <input type="text" class="form-control" name="bulan_pembayaran"
                                        value="<?php if ($this->session->userdata('bulanGET') == NULL) {
