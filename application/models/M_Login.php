...
class M_Login extends CI_Model
{
    ...
    {
        $query   = $this->db->query("SELECT data_login.id_login, data_login.email_login, data_login.password_login, data_login.cluster,
    ...
    // Check data login
    public function CheckDuplicateEmail($email_login)
    {
        $this->db->select('id_login, email_login, password_login');
