...
class M_BelumLunasUser extends CI_Model
{
    ...
    public function BelumLunas($bulan, $tahun, $tanggalAkhir, $area_1, $area_2, $area_3, $area_4, $area_5)
    {
        ...
        data_customer.name_pppoe, data_customer.password_pppoe, data_customer.id_pppoe, data_customer.alamat_customer, data_customer.email_customer, data_customer.disabled, 
        ...
        data_pembayaran.transaction_time IS NULL AND data_customer.stop_date IS NULL AND data_customer.nama_paket != 'EXPIRED' AND
    ...
    public function NominalBelumLunas($bulan, $tahun, $tanggalAkhir, $area_1, $area_2, $area_3, $area_4, $area_5)
    {
        ...
        AND data_pembayaran.transaction_time IS NULL AND  data_customer.stop_date IS NULL AND data_customer.nama_paket != 'EXPIRED' AND
        data_customer.nama_area in ('$area_1', '$area_2', '$area_3', '$area_4', '$area_5')");
