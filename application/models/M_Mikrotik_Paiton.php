...
class M_Mikrotik_Paiton extends CI_Model
{
    ...
    public function Terminasi_Paiton($bulan, $tahun, $tanggalAkhir)
    {
        date_default_timezone_set("Asia/Jakarta");
        $day = (int)date("d");

        if ($day < 11 || $day > 26) {
            return "Di luar rentang tanggal 11 sampai 26.";
        }
    ...
    public function Enable_Paiton($bulan, $tahun, $tanggalAkhir)
    {
        ...
        WHERE 
            ...
            AND data_customer.kode_mikrotik = 'Paiton'
